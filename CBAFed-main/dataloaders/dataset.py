...
class CheXpertDataset(Dataset):
    def __init__(self, dataset_type, root_path,data_np, label_np, pre_w, pre_h, lab_trans=None, un_trans_wk=None, data_idxs=None,
                 is_labeled=False,
                 is_testing=False):
        """
        Args:
    ...
    def __getitem__(self, index):
        ...
        image = Image.fromarray(self.images[index]).convert('RGB')
            #image = Image.fromarray(np.transpose(self.images[index], (0, 2, 1))).convert('RGB')
